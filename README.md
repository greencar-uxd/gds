...
중간 10건 — **✅ 페이지 간격 주석 192건 중 21건이 스케일 밖(`GAP-30`)** · 같은 값 두 이름 6쌍 · ODA 색이 Badge/Brand 로 분리 · 그림자 효과가 Elevation 밖에 9종 더 · Components 25개 중 실측 6개 · Icon 규칙이 두 곳으로 흩어짐 · ✅ 페이지끼리 AOS/Web 폭 불일치(360 vs 365) · ✅ 인데 미해결 메모가 남은 페이지 · Bottom sheet 정의가 Picker ✅ 안에 · **Title 8단계 중 2개가 라이브러리에 없음**
