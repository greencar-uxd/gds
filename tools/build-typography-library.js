 ...
 *
 * 숫자는 손으로 적지 않습니다 — 원본 21단계(data/foundation-data.json)와
...
const out = {
  ...
  generatedFrom: 'tools/build-typography-library.js — data/foundation-data.json(원본 21단계) + data/type-decisions.json(확정 결정)',
  checkedAt: LIB.checkedAt,
  problem: '현재 라이브러리 텍스트 스타일은 5종뿐인데 원본은 21단계입니다. 5종은 스타일이 아니라 «그룹»이고 이름에 단계 번호가 빠져 있어서, 같은 이름으로 여러 개가 published 돼 값이 충돌합니다.',
