...
이 문서는 \`GAP-21\` 을 메우기 위한 것입니다. 아이콘 분류 기준(Lv. 1~3)은 Foundation 의 **Icon** 항목이 근거로 삼습니다.
...
**2026-08-06 정정.** 위 문단은 처음에 "Icon system 페이지는 아직 🚧 이라 이 문서가 유일한 기준입니다"라고 적혀 있었습니다. 페이지를 열어 보니 이름 규칙·아이콘 184종·크기 단계가 있었습니다. 🚧 는 «미완»이지 «빈 페이지»가 아닙니다.

이 문서의 **2D 원칙 · 3D 지양**은 아이콘 제작 규칙으로도 그대로 섭니다 — 레퍼런스(M3 "Don't tilt, rotate, or make icons appear dimensional" · KRDS "Front view로 제작한다")와 같은 방향이며, 이 항목만은 참고가 아니라 **원본에 이미 근거가 있습니다**.
`;
